...
impl NvPair {
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_boolean_value(self.nvp, val) })?;
    ...
    //         sys::nvpair_value_boolean_array(self.nvp, boolean_arr_ptr, size_ptr)
    //     })?;
    ...
    //     let mut val = 0;
    //     let rc = unsafe { sys::nvpair_value_uint8(self.nvp, &mut val) };
    //     value_or_err(val, rc)
    // }
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_uint16(self.nvp, val) })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_uint32(self.nvp, val) })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_uint64(self.nvp, val) })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_double(self.nvp, val) })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_int8(self.nvp, val) })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_int16(self.nvp, val) })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_int32(self.nvp, val) })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_int64(self.nvp, val) })?;
    //     match unsafe { val.as_ref() } {
    ...
    //     NvListError::from_nvlist_rc(unsafe {
    //         sys::nvpair_value_uint8_array(self.nvp, u8arr_ptr, size_ptr)
    //     })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe {
    //         sys::nvpair_value_uint16_array(self.nvp, u16arr_ptr, size_ptr)
    //     })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe {
    //         sys::nvpair_value_uint32_array(self.nvp, u32arr_ptr, size_ptr)
    //     })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe {
    //         sys::nvpair_value_uint64_array(self.nvp, u64arr_ptr, size_ptr)
    //     })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe {
    //         sys::nvpair_value_int8_array(self.nvp, i8arr_ptr, size_ptr)
    //     })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe {
    //         sys::nvpair_value_int16_array(self.nvp, i16arr_ptr, size_ptr)
    //     })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe {
    //         sys::nvpair_value_int32_array(self.nvp, i32arr_ptr, size_ptr)
    //     })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe {
    //         sys::nvpair_value_int64_array(self.nvp, i64arr_ptr, size_ptr)
    //     })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_string(self.nvp, str_ptr) })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe {
    //         sys::nvpair_value_string_array(self.nvp, str_arr_ptr, size_ptr)
    //     })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe { sys::nvpair_value_nvlist(self.nvp, raw_nvlist_ptr) })?;
    ...
    //     NvListError::from_nvlist_rc(unsafe {
    //         sys::nvpair_value_nvlist_array(self.nvp, nvlist_arr_ptr, size_ptr)
    //     })?;
